...
class AiAssistantCleanModule extends Module {
  ...
  void builder(Scope currentScope) {
    ...
    bind<FileSystemDataSource>()
        .toProvide(() => FileSystemDataSourceImpl());
    ...
    bind<ToolApprovalService>()
        .toProvide(() => ToolApprovalServiceFactory.createAdapter(
    ...
    bind<RequestApprovalUseCase>()
        .toProvide(() => RequestApprovalUseCase(
              currentScope.resolve<ToolRepository>(),
            ));
    
    bind<ValidateSafetyUseCase>()
        .toProvide(() => ValidateSafetyUseCase(
              currentScope.resolve<ToolRepository>(),
            ));
    ...
    bind<SwitchAgentUseCase>()
        .toProvide(() => SwitchAgentUseCase(
              currentScope.resolve<AgentRepository>(),
            ));
    
    bind<LoadHistoryUseCase>()
        .toProvide(() => LoadHistoryUseCase(
              currentScope.resolve<AgentRepository>(),
            ));
