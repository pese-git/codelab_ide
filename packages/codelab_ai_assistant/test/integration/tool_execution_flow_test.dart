...
import '../ui/ai_assistant_panel_test.dart';
...
void main() {
  ...
  group('Tool Execution Flow Integration Tests', () {
    ...
    blocTest<AiAgentBloc, AiAgentState>(
      ...
      build: () {
        ...
        return AiAgentBloc(
          ...
          toolApi: mockToolApi,
          approvalService: mockToolApprovalService,
        );
      },
      act: (bloc) {
    ...
    blocTest<AiAgentBloc, AiAgentState>(
      ...
      build: () {
        ...
        when(
          ...
          (_) async =>
              FileOperationResult.readSuccess(content: 'test', linesRead: 1),
        );
    ...
    blocTest<AiAgentBloc, AiAgentState>(
      ...
      verify: (_) {
        verify(
          () => mockProtocol.sendUserMessage('Hello AI', role: 'user'),
        ).called(1);
      },
      expect: () => [
        isA<ChatState>()
    ...
    blocTest<AiAgentBloc, AiAgentState>(
      ...
      act: (bloc) {
        messageController.add(
          const WSMessage.assistantMessage(content: 'Hello', isFinal: false),
        );
      },
      wait: const Duration(milliseconds: 100),
      verify: (_) {
